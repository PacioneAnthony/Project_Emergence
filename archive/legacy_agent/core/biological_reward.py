...
class HomeostaticSystem:
    ...
    def update_state(self, sensor_data):
        ...
        # L'intégrité baisse aussi si "Douleur Sursaturée" (Lumière trop forte)
        brightness = sensor_data.get("light_brightness", 0.0)
        if brightness > 0.95: # Si > 95% blanc (éblouissement)
            impact += 0.05    # Petite douleur mais constante
